...
// Streaming auth proxy for revision-request supporting files (a review
// feedback's attachments). See files/submissions/.../evidence/[fileId] for
...
export async function GET(
  ...
  try {
    const upstream = await fetch(
      `${API_URL}/projects/${id}/files/reviews/${reviewId}/attachments/${attachmentId}`,
    ...
    console.error(
      "GET /api/projects/[id]/files/reviews/[reviewId]/attachments/[attachmentId] error:",
      error,
    );
