...
// Streaming auth proxy for dispute evidence files — same pattern as the
// submissions/payments/change-requests file-proxy routes.
export async function GET(
  ...
  try {
    const upstream = await fetch(`${API_URL}/projects/${id}/files/disputes/${fileId}`, {
    ...
    console.error("GET /api/projects/[id]/files/disputes/[fileId] error:", error);
