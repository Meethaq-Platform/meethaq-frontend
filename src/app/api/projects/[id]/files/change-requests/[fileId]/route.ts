...
// Streaming auth proxy for change-request attachments — same pattern as the
// submissions/payments file-proxy routes (serverApi() isn't reusable since
...
export async function GET(
  ...
  try {
    const upstream = await fetch(
      `${API_URL}/projects/${id}/files/change-requests/${fileId}`,
    ...
    console.error("GET /api/projects/[id]/files/change-requests/[fileId] error:", error);
